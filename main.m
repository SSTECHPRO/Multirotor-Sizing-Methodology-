...
SafetyFactor = 1.5; % [1-2], arbitrary safety parameter
AcceptedTypes = {'MR' 'E-4'}; % preferred propeller series
                  % E	Electric
...
BattCapacity = 6200; % mAh, battery capacity
...
%% Mass data [g]
mass_Frame = 600; % Lumenier QAV500 V2 with 540mm arms
mass_FC = 16; % Vector Flight Controller + OSD
mass_FC_GPS = 33;
mass_FC_CurrentSensor = 150; %other parts camera 2 8g laser 3.5 g servomotor 36 g jetsen nano 100g
mass_Receiver = 15; % FrSky R-XSR 2.4GHz 16CH ACCST
mass_Motor_Est = 65; % FXC4006-13 740kv - 92 g
mass_ESC_Est = 112; % Lumenier 35A BLHeli_S ESC OPTO - 7 g
mass_Propeller_Est = 90; % HQProp 12x4.5 Props - 18g
% mass_Payload = 977;
mass_Payload = 200;
mass_Battery = 540; % Lumenier 5200mAh 4s 35c
